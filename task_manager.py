...
def login():
    ...
    try:
        ...
        # Checking if the Password entered is the same as
...
def task_information(username):
    print("Sir enter the number of tasks you want to ADD")
    j = int(input())
    f1 = open(username, 'a')
    ...
    for i in range(1, j + 1):
        ...
        f1.write(target)
        f1.write('\n')
        print("Do you want to stop? Press space bar, otherwise press Enter.")
        s = input()
        if s == ' ':
            break
    f1.close()
...
if __name__ == '__main__':
    print("WELCOME TO TaskPilot, your Personal TASK MANAGER")
